...
//        term.getPostList().add(post);
    ...
    @Override
    public List<Post> listNewstPostsByType(Post.PostType type, int pageNum, int pageSize) {
        return postDao.findEntitiesByTypeDesc(type, pageSize, (pageNum - 1) * pageSize);
    }
