 ...
 * @since 1.0
 */
public class NavTagSimp extends TagSupport {
...
//  private static final Log LOGGER = LogFactory.getLog(NavigationTag.class);
    ...
    public int doStartTag() throws JspException {
        ...
        try {
            if (onePage.isHasPre()) {
                String preUrl = append(url, "pn", onePage.getPageNum() - 1);
            ...
            if (onePage.isHasNext()) {
                String nextUrl = append(url, "pn", onePage.getPageNum() + 1);
    ...
    private String makeNext(Page<?> page, String url) {
        ...
        sb.append("<input type=\"text\" name=\"pn\" size=\"3\" value=\"1\" format=\"*N\"/>").append(page.getPageNum()).append("/").append(page.getContext().getPageCount()).append("页<anchor>跳转<go href=\"").append(url).append("\" method=\"get\" accept-charset=\"utf-8\">").append("<postfield name=\"pn\" value=\"$pn\"/></go></anchor><br/>");
