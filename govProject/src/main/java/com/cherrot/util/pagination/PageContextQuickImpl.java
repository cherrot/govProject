 ...
 */
public class PageContextQuickImpl<E> implements PageContext<E>{
     ...
     * @param items
     */
    public PageContextQuickImpl(int totalCount, int pageSize, List<E> items) {
