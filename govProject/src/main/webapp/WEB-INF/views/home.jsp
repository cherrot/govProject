              ...
              <table>
                <tr>
                  ...
                  <td width="340px" valign="top">
                    ...
                    <c:set value="${categoryGroups[0]}" var="group"/>
                    <c:set value="1" var="count"/>
                    <div class="groupPanel">
                      <div class="TabADS">
                        <ul>
                          <c:forEach items="${group.categoryList}" var="category" varStatus="categoryStatus">
                            <li id="tabadmenu_${count}${categoryStatus.count}" onmouseover="setTimeout('Show_TabADSMenu(${count},${categoryStatus.count})',200);" <c:if test="${categoryStatus.first}">class="TasADSOn"</c:if>>${category.name}</li>
                          </c:forEach>
                        </ul>
                      </div>
                      <div class="TabADSCon">
                        <c:forEach items="${group.categoryList}" var="category" varStatus="status">
                          <ul id="tabadcontent_${count}${status.count}">
                ...
                <tr>
                  <td width="360px" valign="top">
                    <%--<c:forEach items="${categoryGroups}" begin="1" end="1" var="group" varStatus="groupStatus">--%>
                    <c:set value="${categoryGroups[1]}" var="group"/>
                  ...
                  <td width="340px" valign="top">
                    <c:set value="${categoryGroups[2]}" var="group"/>
                ...
                <tr>
                  <td width="360px" valign="top">
                    <c:set value="${categoryGroups[3]}" var="group"/>
                    <c:set value="4" var="count"/>
                    <div class="groupPanel">
                      <div class="TabADS">
                        <ul>
                          <c:forEach items="${group.categoryList}" var="category" varStatus="categoryStatus">
                  ...
                  <td width="340px" valign="top">
                    <c:set value="${categoryGroups[4]}" var="group"/>
                    <c:set value="5" var="count"/>
                    <div class="groupPanel">
                      <div class="TabADS">
                        <ul>
                          <c:forEach items="${group.categoryList}" var="category" varStatus="categoryStatus">
